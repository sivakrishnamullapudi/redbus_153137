...
public void enter_person_details() throws Throwable {
	Thread.sleep(3000);
	SearchResult.name(driver).sendKeys("Shiva Krishna M");
  SearchResult.selectGender(driver);
  SearchResult.age(driver).sendKeys("21");
  SearchResult.mail(driver).sendKeys("shivakrishnamullapudi@gmail.com");
  SearchResult.mob(driver).sendKeys("9493913969");
